...
export const ListAccountReq: MessageFns<ListAccountReq> = {
  encode(message: ListAccountReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.Option !== undefined) {
      ListOption.encode(message.Option, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListAccountReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListAccountResp: MessageFns<ListAccountResp> = {
  encode(message: ListAccountResp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListAccountResp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.List.push(Account.decode(reader, reader.uint32()));
          continue;
        case 2:
          if (tag !== 16) {
            break;
  ...
  fromJSON(object: any): ListAccountResp {
    return {
      List: globalThis.Array.isArray(object?.List) ? object.List.map((e: any) => Account.fromJSON(e)) : [],
  ...
  toJSON(message: ListAccountResp): unknown {
    ...
    if (message.List?.length) {
      obj.List = message.List.map((e) => Account.toJSON(e));
    }
    if (message.Total !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<ListAccountResp>, I>>(object: I): ListAccountResp {
    const message = createBaseListAccountResp();
    message.List = object.List?.map((e) => Account.fromPartial(e)) || [];
...
function createBaseAccount(): Account {
  return { ID: 0, UserName: "", DisplayName: "", Email: "", State: 0 };
}
...
export const CreateRoleReq: MessageFns<CreateRoleReq> = {
  encode(message: CreateRoleReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.Name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateRoleReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Page: MessageFns<Page> = {
  encode(message: Page, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.AccountList !== undefined) {
      PageOperation.encode(message.AccountList, writer.uint32(10).fork()).join();
    }
    if (message.Role !== undefined) {
      PageOperation.encode(message.Role, writer.uint32(18).fork()).join();
    }
    if (message.Setting !== undefined) {
      PageOperation.encode(message.Setting, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const ListRoleReq: MessageFns<ListRoleReq> = {
  encode(message: ListRoleReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.Option !== undefined) {
      ListOption.encode(message.Option, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListRoleReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRoleResp: MessageFns<ListRoleResp> = {
  encode(message: ListRoleResp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.List) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListRoleResp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetRoleAuthReq: MessageFns<GetRoleAuthReq> = {
  encode(message: GetRoleAuthReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetRoleAuthReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetRoleAuthResp: MessageFns<GetRoleAuthResp> = {
  encode(message: GetRoleAuthResp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.Page !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetRoleAuthResp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateRoleReq: MessageFns<UpdateRoleReq> = {
  encode(message: UpdateRoleReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ID !== "") {
      writer.uint32(10).string(message.ID);
    }
    if (message.Name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateRoleReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteRoleReq: MessageFns<DeleteRoleReq> = {
  encode(message: DeleteRoleReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ID !== "") {
      writer.uint32(10).string(message.ID);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteRoleReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BindRoleReq: MessageFns<BindRoleReq> = {
  encode(message: BindRoleReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BindRoleReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UnBindRoleReq: MessageFns<UnBindRoleReq> = {
  encode(message: UnBindRoleReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.AccountID !== "") {
      writer.uint32(10).string(message.AccountID);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UnBindRoleReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LoginResp: MessageFns<LoginResp> = {
  encode(message: LoginResp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
