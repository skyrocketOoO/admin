...
type ListOption struct {
	...
	FilterGroup *FilterGroup `protobuf:"bytes,3,opt,name=filterGroup,proto3,oneof" json:"filterGroup,omitempty"` // Root of filter expressions.
}
...
func (x *ListOption) GetFilterGroup() *FilterGroup {
	if x != nil {
...
type Filter struct {
	...
	Field *string `protobuf:"bytes,1,opt,name=field,proto3,oneof" json:"field,omitempty"` // filed not set = query all fields
...
type FilterGroup struct {
	...
	Operator     Operator       `protobuf:"varint,1,opt,name=operator,proto3,enum=proto.Operator" json:"operator,omitempty"` // Logical operator (AND/OR) to combine filters.
	Filters      []*Filter      `protobuf:"bytes,2,rep,name=filters,proto3" json:"filters,omitempty"`                        // List of individual filters.
	NestedGroups []*FilterGroup `protobuf:"bytes,3,rep,name=nestedGroups,proto3" json:"nestedGroups,omitempty"`              // Nested filter groups for recursive logic.
}
...
func (x *FilterGroup) GetOperator() Operator {
	if x != nil {
		return x.Operator
	}
	return Operator_AND
...
func (x *FilterGroup) GetNestedGroups() []*FilterGroup {
	if x != nil {
...
var file_common_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0xb3,
	...
	0x39, 0x0a, 0x0b, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x46, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x48, 0x01, 0x52, 0x0b, 0x66, 0x69, 0x6c, 0x74,
	0x65, 0x72, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x88, 0x01, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x70,
	0x61, 0x67, 0x65, 0x72, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x47,
	0x72, 0x6f, 0x75, 0x70, 0x22, 0x33, 0x0a, 0x05, 0x50, 0x61, 0x67, 0x65, 0x72, 0x12, 0x16, 0x0a,
	...
	,
...
var file_common_proto_goTypes = []any{
	...
	(*FilterGroup)(nil), // 6: proto.FilterGroup
}
var file_common_proto_depIdxs = []int32{
	3, // 0: proto.ListOption.pager:type_name -> proto.Pager
	4, // 1: proto.ListOption.sorters:type_name -> proto.Sorter
	6, // 2: proto.ListOption.filterGroup:type_name -> proto.FilterGroup
	0, // 3: proto.FilterGroup.operator:type_name -> proto.Operator
	5, // 4: proto.FilterGroup.filters:type_name -> proto.Filter
	6, // 5: proto.FilterGroup.nestedGroups:type_name -> proto.FilterGroup
